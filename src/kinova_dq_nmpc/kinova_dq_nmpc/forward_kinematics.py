...
## Section to create a funciton that takes the pose using trasnlatin and quaternion and generates the dual quaternion
# Auxiliar values to create the dual quaternion
